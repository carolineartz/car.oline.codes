...
import s from './BongoCat.scss';

export const BongoCat = () => {
  return (
    <svg className={s.bongocat} xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" viewBox="0 0 787.3 433.8">
      <defs>
        ...
        <symbol id="pawpads" viewBox="0 0 31.4 33.9">
      ...
      <g className={s.table}>
        <path d="M65.7,181.8l714,124c0,74-2,54-2,128l-673-161Z"/>
      ...
      <g className={s.laptop}>
        <g className={s.laptop__base}>
        ...
        <g className={s.keyboard__outer}>
          <polygon points="371.3 273.9 256.9 252.7 266.4 250.3 382.4 271.5 371.3 273.9" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="237.6 264.9 221.4 261.7 230.4 259.4 246.8 262.6 237.6 264.9" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="474.8 312 250 267.3 259.4 265.1 487.7 309.6 474.8 312" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="412 308.5 204.4 266 213.1 263.8 423.9 306.3 412 308.5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="450.2 316.4 428.8 312 440.9 309.7 462.8 314.1 450.2 316.4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="201.7 273.1 187.7 270.2 196.2 268 210.4 271 201.7 273.1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="222.8 277.6 208.3 274.5 217.1 272.4 231.8 275.4 222.8 277.6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="363.1 307.3 231.7 279.5 240.9 277.3 374.2 305.1 363.1 307.3" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="444.6 287.5 385.4 276.5 396.8 274.1 456.9 285 444.6 287.5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="526.3 302.7 460.3 290.4 473 288 540.1 300.2 526.3 302.7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
          <polygon points="426.4 320.7 376.3 310.1 387.6 307.9 438.5 318.5 426.4 320.7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"/>
        ...
        <g className={s.pawr}>
          ...
          <g className={s.pawr__up}>
            ...
            <use width="31.4" height="33.93" transform="translate(273.2 166.1) rotate(-5.6)" xlinkHref="#pawpads"/>
          </g>
        </g>
        <g className={s.laptop__terminal}>
        ...
        <g className={s.laptop__code}>
          <g strokeWidth="6" transform="matrix(-1 0 0 1 278 103)">
            <g className={s.f3} transform="translate(0 76)">
              <path className={s.f3__l9} d="M8,25L8,25" strokeDasharray="60,10"/>
              <path className={s.f3__l8} d="M8,13L8,13" strokeDasharray="50,10"/>
              <path className={s.f3__l7} d="M0,1L0,1" strokeDasharray="25,10"/>
            </g>
            <g className={s.f2} transform="translate(0 38)">
              <path className={s.f2__l6} d="M8,25L8,25" strokeDasharray="40,10"/>
              <path className={s.f2__l5} d="M8,13L8,13" strokeDasharray="60,10"/>
              <path className={s.f2__l4} d="M0,1L0,1" strokeDasharray="30,10"/>
            </g>
            <g className={s.f1}>
              <path className={s.f1__l3} d="M8,25L8,25" strokeDasharray="60,10"/>
              <path className={s.f1__l2} d="M8,13L8,13" strokeDasharray="60,10"/>
              <path className={s.f1__l1} d="M0,1L0,1" strokeDasharray="60,10"/>
            </g>
          </g>
        </g>
        <g className={s.laptop__cover}>
      ...
      <g className={s.pawl}>
        <g className={s.pawl__up}>
          ...
          <use width="31.4" height="33.93" transform="matrix(0.99, -0.03, 0.04, 1, 539.85, 203.52)" xlinkHref="#pawpads"/>
        </g>
        <g className={s.pawl__down}>
