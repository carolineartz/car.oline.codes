  ...
  class Overlay {
    ...
    revealItem() {
      ...
      for (let el of itemElems) {
        ...
        TweenMax.to(
          el,
          lineEq(0.8, 1.2, win.width, 0, Math.abs(bounds.left + bounds.width - win.width)),
          {
            ease: 'Expo.easeOut',
            delay: 0.2,
            startAt: {
        ...
        for (let key in item.DOM.animatable) {
          ...
          if (el) {
            ...
            if (bounds.top + bounds.height / 2 < win.height / 2 - win.height * 0.1) {
              ...
              x =
                -1 *
                lineEq(20, 600, 0, win.width, Math.abs(bounds.left + bounds.width - win.width));
              y =
                -1 *
                lineEq(20, 600, 0, win.width, Math.abs(bounds.left + bounds.width - win.width));
              ...
              x =
                -1 *
                lineEq(10, 700, 0, win.width, Math.abs(bounds.left + bounds.width - win.width));
